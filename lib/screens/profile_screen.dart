    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () => Provider.of<ProfileManager>(context, listen: false).tapOnProfile(false),
        ),
      ),
      body: Center(
        child: Column(
    ...
    return ListView(
      children: [
        ...
        ListTile(
          ...
          onTap: () => Provider.of<ProfileManager>(context, listen: false).tapOnRaywenderlich(true),
        ),
        ListTile(
