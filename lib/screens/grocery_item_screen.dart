      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Center(child: Text('Preview', style: GoogleFonts.lato(color: Colors.grey, fontStyle: FontStyle.italic))),
            const SizedBox(height: 10.0),
            GroceryTile(
              item: GroceryItem(
                id: 'previewMode',
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: _currentColor)),
            border: UnderlineInputBorder(borderSide: BorderSide(color: _currentColor)),
          ),
        ),
      ],
    );
        ...
        Wrap(
          ...
          children: [
            ChoiceChip(
              ...
              onSelected: (selected) => setState(() => _importance = Importance.low),
            ),
            ChoiceChip(
              label: const Text('Medium', style: TextStyle(color: Colors.white)),
              selected: _importance == Importance.medium,
              selectedColor: Colors.black,
              onSelected: (selected) => setState(() => _importance = Importance.medium),
            ),
            ChoiceChip(
              label: const Text('High', style: TextStyle(color: Colors.white)),
              selected: _importance == Importance.high,
              selectedColor: Colors.black,
              onSelected: (selected) => setState(() => _importance = Importance.high),
            ),
          ],
        )
      ],
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
              child: const Text('Select'),
              onPressed: () async {
                final timeOfDay = await showTimePicker(initialTime: TimeOfDay.now(), context: context);
            ...
            showDialog(
              ...
              builder: (context) {
                return AlertDialog(
                  ...
                  actions: [
                    TextButton(child: const Text('Save'), onPressed: Navigator.of(context).pop),
                  ],
                );
              },
            );
    ...
    return Column(
      ...
      children: [
        ...
        Slider(
          ...
          onChanged: (double value) => setState(() => _currentSliderValue = value.toInt()),
        ),
      ],
    );
  }
